...
const AdminProfile = () => {
    ...
    return (
        <div style={{ overflowX: 'hidden', position: 'relative', height: '100vh', width: '100%', paddingLeft: '30px' }}>
                ...
                <div >
                <Typography variant="h5" color="white">Id: {id}</Typography>
                      
                <Typography variant="h5" color="white">Name: {name}</Typography>
                        <br /><br />
                        <Typography variant="h5" color="white">Email:{email}</Typography>
                    </div>
